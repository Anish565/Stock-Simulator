...
const Dashboard: React.FC = () => {
  ...
  // Sample data for stocks and news
  const stocks = [
      ...
      <div className="flex flex-col">
        <div className="flex-grow p-6 space-y-6">
          <div className="flex space-x-6 h-64">
            ...
            <div className="flex-1 bg-blue-800 h-full flex items-center justify-center text-green-200 rounded">
              Stock Visualizations
            </div>

            {/* List of Stocks */}
            <div className="w-1/3 bg-[#8b4242] h-full p-4 overflow-y-auto rounded">
              <h3 className="text-white font-semibold mb-4">List of Stocks</h3>
          ...
          <div className="flex space-x-6 h-64">
            {/* Session Section */}
            <div className="flex-1 bg-gray-300 h-full p-4 rounded relative overflow-y-auto">
              
              {sessions.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full">
                  <button
                    className="bg-[#a49898] text-white p-4 rounded-sm mb-2 flex items-center justify-center active:scale-95 transition-transform duration-100"
                    onClick={openModal}
                  >
            ...
            {/* News Section */}
            <div className="w-1/3 bg-gray-300 h-full p-4 overflow-y-auto rounded">
              <h3 className="text-black font-semibold mb-4">News</h3>
              <div className="space-y-4">
