      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="flex-grow p-6 space-y-6">
          <div className="flex space-x-6 h-64">
            {/* Stock Visualizations - Updated styling */}
            <div className="flex-1 bg-gray-500/50 backdrop-blur-sm border border-gray-700 rounded-lg shadow-lg h-full flex items-center justify-center text-gray-300">
              Stock Visualizations
            </div>

            {/* List of Stocks - Updated styling */}
